                  ...
                  <td className="py-4 px-6 text-center">
                    <button
                      ...
                      className={`text-sm px-4 py-2 rounded-xl font-medium transition-all ${
                        store.is_active 
                          ? 'bg-slate-50 text-red-600 hover:bg-red-50 hover:text-red-700' 
                          : 'bg-emerald-50 text-emerald-600 hover:bg-emerald-100 hover:text-emerald-700'
                      }`}
                    >
                      {store.is_active ? 'Blokir Akses' : 'Aktifkan Toko'}
                    </button>
                  </td>
                </tr>
              ))}
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input required type="text" className="w-full p-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none"
                  ...
                  <div>
                    ...
                    <input type="text" className="w-full p-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none"
                      value={formData.phone} onChange={e=>setFormData({...formData, phone: e.target.value})} />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Alamat</label>
                    <textarea className="w-full p-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none"
                      value={formData.address} onChange={e=>setFormData({...formData, address: e.target.value})} />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Paket Langganan (Awal)</label>
                    <select className="w-full p-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none"
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input required type="email" className="w-full p-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none"
